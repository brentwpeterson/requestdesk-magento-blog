...
/**
 * Resource model for requestdesk_blog_author. Unlike the retired profile table,
 * the primary key is a real auto-increment id.
 */
class Author extends AbstractDb
{
    ...
    {
        $this->_init('requestdesk_blog_author', 'author_id');
    }
}
