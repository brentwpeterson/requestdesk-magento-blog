<?php
/**
 * RequestDesk Blog - Admin Mass Mark Comments as Spam
 *
 ...
 */
class MassSpam extends Action implements HttpPostActionInterface
{
    /**
     * @inheritdoc
     */
    ...
    public function execute(): Redirect
    {
        ...
        try {
            ...
            $count = $this->commentManager->moderate($ids, Comment::STATUS_SPAM);
            $this->messageManager->addSuccessMessage(__('%1 comment(s) marked as spam.', $count));
        } catch (\Throwable $e) {
